        ...
        <Grid item xs={12} className={classes.gridList}>
          ...
          {isEnd && (
            <Grid item>
              ...
              <Grid container className={classes.gridListTask}>
                <List subheader={<ListSubheader>PODANE SŁOWO</ListSubheader>}>
                  {finalArray.map((word) => {
                    if (n < 7) {
                      n += 1;
                      return (
                ...
                <List
                  subheader={<ListSubheader>POPRAWNA ODPOWIEDŹ</ListSubheader>}
                >
                  {finalArray.map((word) => {
                    if (m < 7) {
                      m += 1;
                ...
                <List
                  subheader={<ListSubheader>TWOJA ODPOWIEDŹ</ListSubheader>}
                >
                  {finalArray.map((word) => (
                    <ListItem key={word.key + '$'}>
                      <TextField
